...
export async function inspectRuntimeAdapters(root = ".") {
  ...
  return {
    ...
    nextGate: "durable-single-use-execution-lease-actual-provider-caller-descendant-fencing-event-normalization-cancellation-close-and-provider-session-lifecycle-conformance",
  };
}
