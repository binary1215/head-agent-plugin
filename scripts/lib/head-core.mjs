...
export function coreContract() {
  return {
    ...
    deferredCapabilities: ["initial-onboarding-candidate-review", "changeset-temporal-provenance", "feature-code-mapping-candidates", "authorized-relationship-promotion", "compute-backed-graph-and-context-operations", "go-repository-scan-operation", "native-worker-descendant-tree-supervision", "ast-accurate-semantic-call-graph", "live-runtime-state-probe", "structured-git-decision-inference", "graphdb-world-model-store-adapter", "provider-runtime-fresh-head-hydration", "authorized-knowledge-promotion", "live-caller-fencing", "agent-comm", "service-host", "herdr"],
  };
}
