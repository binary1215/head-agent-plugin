...
- common measurement evidence: `ObservationTypeDescriptor`, `ObservationCollectionReceipt`, `ObservationRecord`, and `DerivedObservationRecord`, with interpretation remaining outside graph authority.
...
- common Observation shapes and derivations through `CONFORMS_TO`, `EVIDENCED_BY`, and `DERIVED_FROM`.
