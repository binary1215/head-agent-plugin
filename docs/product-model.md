...
This slice does not treat inferred code or documentation meaning as canon without review. Feature-to-code, Feature-to-test, and ChangeSet-to-product impact mappings use separate immutable candidates and explicit ReviewDecision contracts, but they do not mutate Product Canon. Provider-neutral ChangeSets record reviewed change lineage rather than redefining product intent. Deterministic Markdown is a derived GraphSnapshot view, and edited pages become candidates rather than Product Canon. Dedicated imported-backlog adapters, broader conformance relations, DocumentChangeCandidate review/application, and Obsidian/Notion projections remain deferred.
