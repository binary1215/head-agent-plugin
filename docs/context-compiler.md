...
Context Compiler protocol `0.8.0` uses a deterministic lexical ranker so a Capsule can be reproduced without a model call. Model-assisted compilation can be added later behind the same data contracts.
