...
if (path.basename(output) !== "ARCADEDB-BRIDGE-MANIFEST.json") throw new Error("--output must end in ARCADEDB-BRIDGE-MANIFEST.json.");
const manifest = createArcadeDbNativeBridgeManifest({ platform, arch, binaryFile, manifestDirectory: path.dirname(output) });
